...
var quote1 = 'Someone said, "Trying and Failing is better than Failing to try."';
console.log(quote1);
...
var friends_names = ["Abdul", "Abdullah", "Farhan", "Hafiz"];
...
var fav_mode = ["Honda 70", "Honda 125", "Yamaha YBR", "Toyota Crown"];
...
var guest_list = ["Allama Iqbal", "Salah-ud-Din Ayubi", "Quaid-e-Azam"];
...
var fav_places = ["Silicon Valley", "Norway", "USA", "Madina", "Italy"];
var copy_fav_places = [...fav_places];
...
var some_thing = ["K2", "Ravi", "Italy", "Norway", "Milan", "Greensboro", "Hebrew"];
...
let _numbers = [11, 22, 33, 44, 55, 66, 77,];
...
var fav_fruits = ["Apple", "Mango", "Strawberry", "Peach", "Orange"];
...
var user_name = ["Admin", "Abdul", "Abdullah", "Farhan", "Hamza"];
...
var no_users = ["Abdul", "Farhan", "Hamza", "Abdullah", "Usman"];
...
var current_users = ["Abdul", "Farhan", "Hamza", "Abdullah", "Usman"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
var new_users = ["Abdul", "Zohaib", "Farhan", "Hamza", "Muneel", "Abdullah", "Usman"];
...
var fav_pizza = ["Fajita", "Cheese Lover", "Mexican"];
...
var animals = ["Dolphin", "Flying Fish", "Pterosaur"];
...
var magicians_names = ["Asad", "Ahmad", "Farhan", "Hamza"];
...
var magicians_names = ["Asad", "Ali", "Farhan", "Hamza"];
function make_great1(magician = "Great") {
    ...
    var copy_magician_name = [...magicians_names];
